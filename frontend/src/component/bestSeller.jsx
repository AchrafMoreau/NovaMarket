...
export const BestSeller = () => {
    ...
    return (
        <>
            <div className="col-md-4 prod1"
                onMouseEnter={()=> setHover1(true)}
                onMouseLeave={()=> setHover1(false)}
            >
                <img src="/images/lipstick-removebg-preview.png" className="img-fluid" alt="" />
                <h4>Lipstick</h4>
